...
def main():
  ...
  elif (month=="September" and day>=22) or (month=="October" and 0<day<=31) or (month=="November" and 0<day<=3) or(month=="December" and 0<day<=20):
      print(f'{month} {day} is in Fall')
  elif (month=="June" and 22<=day<30) or (month=="July" and 0<day<=31) or (month=="August" and 0<day<31) or (month=="September" and 0<day<22):
